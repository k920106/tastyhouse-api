...
public class NoticeCoreService {
    ...
    public NoticePageResult findAllWithPagination(Long companyId, String title, Boolean active, LocalDate startDate, LocalDate endDate,
                                                 int page, int size) {
        PageRequest pageRequest = PageRequest.of(page, size);
        Page<NoticeListItemDto> noticePage = noticeRepository.findAllWithFilter(
    ...
    public Notice createNotice(Long companyId, String title, String content, Boolean active, Boolean top) {
        Notice notice = new Notice();
        notice.setCompanyId(companyId);
        notice.setTitle(title);
        notice.setContent(content);
        notice.setActive(active != null ? active : true);
        notice.setTop(top != null ? top : false);

        return noticeJpaRepository.save(notice);
    }

    public Notice updateNotice(Long id, Long companyId, String title, String content, Boolean active, Boolean top) {
