...
@Getter
@Entity
@Table(name = "COMMON_OPTION_GROUP")
public class CommonOptionGroup extends BaseEntity {
    ...
    @Builder
    public CommonOptionGroup(Long placeId, String name, String description, Boolean isRequired,
